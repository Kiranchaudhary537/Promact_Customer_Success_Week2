...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7aadb392-e143-4ee6-9bf1-a716564d9e3d
```

> `7aadb392-e143-4ee6-9bf1-a716564d9e3d` is the password of the certificate, you can change it to any password you want.
